...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { author_name: @quotation.author_name, category_id: @quotation.category_id, quote: @quotation.quote }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { author_name: @quotation.author_name, category_id: @quotation.category_id, quote: @quotation.quote }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
